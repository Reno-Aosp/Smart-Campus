-- =====================================================
-- SMART CAMPUS DATABASE SCHEMA FOR ORACLE
-- =====================================================
...
DROP TABLE kelas_mahasiswa CASCADE CONSTRAINTS;
DROP TABLE mata_kuliah CASCADE CONSTRAINTS;
DROP TABLE kelas CASCADE CONSTRAINTS;
DROP TABLE mahasiswa CASCADE CONSTRAINTS;
DROP TABLE dosen CASCADE CONSTRAINTS;
DROP TABLE program_studi CASCADE CONSTRAINTS;
DROP TABLE users CASCADE CONSTRAINTS;

-- Drop sequences
DROP SEQUENCE seq_user_id;
DROP SEQUENCE seq_prodi_id;
DROP SEQUENCE seq_dosen_id;
DROP SEQUENCE seq_mahasiswa_id;
DROP SEQUENCE seq_kelas_id;
DROP SEQUENCE seq_matkul_id;
DROP SEQUENCE seq_jadwal_id;
DROP SEQUENCE seq_absensi_id;
DROP SEQUENCE seq_nilai_id;
